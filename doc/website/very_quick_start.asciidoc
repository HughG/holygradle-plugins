...
TODO: ...  See also the link:workflows.html[] page.  [TODO: Link to section within?]
...
TODO: The name of the project is controlled by the folder it's in.
...
glowss:repositories[] which contain the project's dependencies.  The team which owns the project
...
the Holy Gradle will pop up a dialog to prompt you for the username and password.  This will also
happen if the project has gloss:source-dependencies[] you may be prompted separately for those.  It
stores them in the gloss:credential-manager[] so you will not need to supply them again until you
change your password.

TODO: Link to some reference page on password updates.
