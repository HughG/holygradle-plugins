...
digraph "Build Dependencies" {
    ...
    task -> test_src [style=invisible,arrowhead=none]
    configuration -> compile [style=invisible,arrowhead=none]
    dependency -> library3 [style=invisible,arrowhead=none]

    testCompile -> compile [arrowhead=empty]
