...
digraph {
    ...
    subgraph cluster_a {
        ...
        a_compileVc10Win32Debug [label="compileVc10-\nWin32Debug"];
        a_compileVc10X64Release [label="compileVc10-\nX64Release"];
        a_runtimeVc10Win32Debug [label="runtimeVc10-\nWin32Debug"];
        a_runtimeVc10X64Release [label="runtimeVc10-\nX64Release"];
        a_debuggingVc10Win32Debug [label="debuggingVc10-\nWin32Debug"];
        a_debuggingVc10X64Release [label="debuggingVc10-\nX64Release"];
        a_privateBuild [label="privateBuild"];

        a_compileVc10Win32Debug -> a_headers [arrowhead="onormal"];
        a_compileVc10X64Release -> a_headers [arrowhead="onormal"];
        a_debuggingVc10Win32Debug -> a_runtimeVc10Win32Debug [arrowhead="onormal"];
    ...
    subgraph cluster_b {
        ...
        b_compileVc10Win32Debug [label="compileVc10-\nWin32Debug"];
        b_compileVc10X64Release [label="compileVc10-\nX64Release"];
        b_runtimeVc10Win32Debug [label="runtimeVc10-\nWin32Debug"];
        b_runtimeVc10X64Release [label="runtimeVc10-\nX64Release"];
        b_debuggingVc10Win32Debug [label="debuggingVc10-\nWin32Debug"];
        b_debuggingVc10X64Release [label="debuggingVc10-\nX64Release"];
        b_privateBuild [label="privateBuild"];

        b_compileVc10Win32Debug -> b_headers [arrowhead="onormal"];
        b_compileVc10X64Release -> b_headers [arrowhead="onormal"];
        b_debuggingVc10Win32Debug -> b_runtimeVc10Win32Debug [arrowhead="onormal"];
        b_debuggingVc10X64Release -> b_runtimeVc10X64Release [arrowhead="onormal"];

        b_privateBuild -> Doxygen_bin;
    }

    a_compileVc10Win32Debug -> b_compileVc10Win32Debug;
    a_compileVc10Win32Release -> b_compileVc10Win32Release;
    a_runtimeVc10Win32Debug -> b_runtimeVc10Win32Debug;
    a_runtimeVc10X64Release -> b_runtimeVc10X64Release;
    a_debuggingVc10Win32Debug -> b_debuggingVc10Win32Debug;
