...
TODO: Move to reference page on extending configurations.
...
are expressed as dependencies between gloss:configuration[]s of that module, and those of other
modules.

When Gradle downloads gloss:artifact[]s for a module defined as a dependency of a given project, it
