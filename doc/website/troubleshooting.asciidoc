...
download the gloss:holygradle[] plugins.  From version link:release_notes.html#_plugins_7.0.0[] the
...
The username and password used to access Mercurial link:plugin-intrepid.html#_sourceDependencies[]
