...
link:release_notes.html#7.5.0 it can be set up automatically using a DNS lookup file in your project's
source code.  See link:first_steps.html#_setting_up_a_gradle_wrapper[] and
