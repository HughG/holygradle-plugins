...
rebuildSymlinks - Rebuild all links.
...
This task deletes any links created by +rebuildSymlinks+ or +fetchAllDependencies+. This is not a blanket deletion of all links; only links which **would** be created by the other tasks are deleted.
