...
This block was deprecated as of version link:release_notes.html#_7_7_0[] and removed as of version TODO.

===== group

This method was removed as of version TODO.
...
This method was removed as of version 7.7.0.  The behaviour it was intended to provide -- switching
...
In this case, if you run Gradle from a non-admin command prompt, you'll get an exception like the following.
...
In any case, putting your cache on a share is not recommended, for performance reasons.
...
WARNING: The group and version methods in this block were removed as of version TODO.  Instead, you should just set the
group and version at the top level of the file, near the beginning, as shown in the example build script at the top of
...
+generateDescriptorFileForIvyPublication+.  This will create the gloss:ivy-xml[] for your module in
...
Previous versions of the gloss:holygradle[] allowed published packed dependencies to specify that their transitive
dependencies should appear at some other relative location.  This feature was removed as of version TODO.


=== Ivy files

Previous versions of the gloss:holygradle[] would include the relative location of source dependencies and packed
dependencies in the +ivy.xml+ file.  This feature was removed as of version TODO.
