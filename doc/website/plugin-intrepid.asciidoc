...
* for this module using the [TODO" link to configurationSets] DSL.
...
TODO: link to overview on configuration mapping.
...
WARNING: This block is deprecated as of version 7.7.0 [TODO: link], and will be removed in a future
...
in your build script (see
http://www.gradle.org/docs/1.4/userguide/userguide_single.html#N10607[repositories] in the Gradle
documentation.) This element should be placed in the root of your build script (i.e. outside of any
...
gloss:gradle-distribution[] used by the gloss:holygrade[]'s gloss:gradle-wrapper[] will be placed in
its own subfolder.
