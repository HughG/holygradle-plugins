...
+<sourceOverride>/all-dependencies.xml+ containing a full list of immediate and transitive
	...
	"subproject" {
		...
		ivyFileGenerator { SourceOverrideHandler handler ->
			...
			return [
				...
				new File("C:/projects/framework", "subproject/all-dependencies.xml")
			]
		}
	}
}
	...
	"framework" {
		...
		ivyFileGenerator {
			return [
				...
				new File("C:/projects/framework", "all-dependencies.xml")
			]
		}
	}
}
