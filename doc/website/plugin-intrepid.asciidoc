...
for this module using the <<_configurationSets>> DSL, suitable for this module packaging a DLL, and
having unit test executables which may have different dependencies.
