...
. The Gradle Wrapper does some bootstrapping to ensure that Gradle is on your machine.  The file
+gradle/distributionPath.txt contains a URL path to a specific link:custom-gradle.html[] version.
