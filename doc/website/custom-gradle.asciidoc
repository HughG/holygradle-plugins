...
From version link:release_notes.html#_custom_gradle_7.5.0[7.5.0] of the gradle _wrapper_, +gw.bat+ will attempt to set
this variable based on the file +gradle/base-url-lookup.txt+.  You can add this file to your source code, or it may be
available as part of a +wrapper-starter-kit+ in your organisation -- see
